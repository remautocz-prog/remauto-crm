-- RemAuto CRM: Detailing services seed from "Черновик цен.xlsx"
-- Migration 019 (Price CZ + Прайс Ру + Комплексы)
-- Idempotent: skips insert when name_cs already exists in category.
